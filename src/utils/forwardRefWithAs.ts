...
export type PropsWithAs<P, E extends React.ElementType> = React.PropsWithChildren<P> & { as?: E };
...
function forwardRefWithAs<P extends object, E extends React.ElementType>(
  ...
  return React.forwardRef((props: React.PropsWithoutRef<PropsWithAs<P, E>>, ref: React.Ref<any>) => 
