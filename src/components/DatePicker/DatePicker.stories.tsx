...
export const WithValue: Story = {
  name: 'With Value',
  render: () => (
    <DatePicker value={{ year: 2026, month: 2, day: 19 }} />
  ),
};
...
export const WithMinMax: Story = {
  ...
  render: () => (
    <DatePicker
      ...
      maxDate={{ year: 2026, month: 2, day: 28 }}
    />
  ),
};
...
export const Disabled: Story = {
  render: () => <DatePicker disabled value={{ year: 2026, month: 2, day: 19 }} />,
};
...
export const ExControlled: Story = {
  ...
  render: () => {
    ...
    return (
      <Box display="flex" flexDirection="column" gap="16" style={{ width: '300px' }}>
