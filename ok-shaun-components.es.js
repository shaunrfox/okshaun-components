...
import { forwardRef as B1, useMemo as I1, createElement as a1, useEffect as Y, createContext as d2, useState as G, useContext as c2, useRef as E1 } from "react";
import { jsx as l, jsxs as V, Fragment as b0 } from "react/jsx-runtime";
function t1(t) {
  return typeof t == "object" && t != null && !Array.isArray(t);
}
var m2 = (t) => typeof t == "object" && t !== null;
function j(t) {
  return Object.fromEntries(Object.entries(t ?? {}).filter(([a, o]) => o !== void 0));
}
var h2 = (t) => t === "base";
function p2(t) {
  return t.slice().filter((a) => !h2(a));
}
function O1(t) {
...
function w2(t) {
  let a = "", o;
  for (o = Math.abs(t); o > 52; o = o / 52 | 0) a = O1(o % 52) + a;
  return O1(o % 52) + a;
}
function v2(t, a) {
  let o = a.length;
...
function g2(t) {
  return w2(v2(5381, t) >>> 0);
}
var u0 = /\s*!(important)?/i;
function b2(t) {
  return typeof t == "string" ? u0.test(t) : !1;
}
function u2(t) {
  return typeof t == "string" ? t.replace(u0, "").trim() : t;
}
function S1(t) {
...
}, y2 = /* @__PURE__ */ new Set(["__proto__", "constructor", "prototype"]);
function C1(...t) {
  return t.reduce((a, o) => (o && Object.keys(o).forEach((e) => {
    if (y2.has(e)) return;
    const r = a[e], s = o[e];
    t1(r) && t1(s) ? a[e] = C1(r, s) : a[e] = s;
  }), a), {});
}
var x2 = (t) => t != null;
function H1(t, a, o = {}) {
  ...
  function s(n, i = []) {
    if (m2(n)) {
      const h = {};
      for (const [w, p] of Object.entries(n)) {
        const x = (r == null ? void 0 : r(w, p)) ?? w, g = [...i, x];
        if (e != null && e(n, g))
          return a(n, i);
        const b = s(p, g);
        x2(b) && (h[x] = b);
...
function f2(t, a) {
  return Array.isArray(t) ? t.map((o) => a(o)) : t1(t) ? H1(t, (o) => a(o)) : a(t);
}
function _2(t, a) {
  return t.reduce(
    (o, e, r) => {
...
function y0(t, a, o = !0) {
  ...
  return H1(
    t,
    (i) => Array.isArray(i) ? _2(i, r.breakpoints.keys) : i,
    {
      stop: (i) => Array.isArray(i),
      getKey: o ? (i) => s ? n(i) : i : void 0
    }
  );
}
var q2 = {
  ...
  finalize: (t) => t,
  breakpoints: { keys: [] }
}, k2 = (t) => typeof t == "string" ? t.replaceAll(/[\n\s]+/g, " ") : t;
function x0(t) {
  const { utility: a, hash: o, conditions: e = q2 } = t, r = (n) => [a.prefix, n].filter(Boolean).join("-"), s = (n, i) => {
    let h;
    if (o) {
      const w = [...e.finalize(n), i];
      h = r(a.toHash(w, g2));
    } else
      h = [...e.finalize(n), r(i)].join(":");
    return h;
  };
  return y(({ base: n, ...i } = {}) => {
    const h = Object.assign(i, n), w = y0(h, t), p = /* @__PURE__ */ new Set();
    return H1(w, (x, g) => {
      if (x == null) return;
      const b = b2(x), [C, ...T] = e.shift(g), M = p2(T), I = a.transform(C, u2(k2(x)));
      let k = s(M, I.className);
      b && (k = `${k}!`), p.add(k);
    }), Array.from(p).join(" ");
  });
}
function z2(...t) {
  return t.flat().filter((a) => t1(a) && Object.keys(j(a)).length > 0);
}
function V2(t) {
  function a(r) {
    const s = z2(...r);
    return s.length === 1 ? s : s.map((n) => y0(n, t));
  }
  function o(...r) {
    return C1(...a(r));
  }
...
var M2 = /([A-Z])/g, B2 = /^ms-/, S2 = y((t) => t.startsWith("--") ? t : t.replace(M2, "-$1").replace(B2, "-ms-").toLowerCase()), C2 = ["min", "max", "clamp", "calc"], H2 = new RegExp(`^(${C2.join("|")})\\(.*\\)`), L2 = (t) => typeof t == "string" && H2.test(t), P2 = "cm,mm,Q,in,pc,pt,px,em,ex,ch,rem,lh,rlh,vw,vh,vmin,vmax,vb,vi,svw,svh,lvw,lvh,dvw,dvh,cqw,cqh,cqi,cqb,cqmin,cqmax,%", T2 = `(?:${P2.split(",").join("|")})`, A2 = new RegExp(`^[+-]?[0-9]*.?[0-9]+(?:[eE][+-]?[0-9]+)?${T2}$`), I2 = (t) => typeof t == "string" && A2.test(t), E2 = (t) => typeof t == "string" && /^var\(--.+\)$/.test(t), L1 = {
  map: f2,
  isCssFunction: L2,
  isCssVar: E2,
  isCssUnit: I2
...
}, $ = (t, a) => t.filter((o) => o.css[a]).map((o) => ({ ...o, css: o.css[a] }));
function u(t, ...a) {
  const o = Object.getOwnPropertyDescriptors(t), e = Object.keys(o), r = (n) => {
    const i = {};
    for (let h = 0; h < n.length; h++) {
      const w = n[h];
      o[w] && (Object.defineProperty(i, w, o[w]), delete o[w]);
    }
    return i;
...
const j1 = (t) => V0.get(t) || t, M0 = {
  ...
  utility: {
    transform: (t, a) => {
      const o = j1(t);
      return { className: `${z0.get(o) || S2(o)}_${S1(a)}` };
    },
    hasShorthand: !0,
    toHash: (t, a) => a(t.join(":")),
    resolveShorthand: j1
...
function B0(t) {
  const { base: a, variants: o, defaultVariants: e, compoundVariants: r } = F1(t), s = (g) => ({ ...e, ...j(g) });
  function n(g = {}) {
    var M;
    const b = s(g);
    let C = { ...a };
    for (const [I, k] of Object.entries(b))
      (M = o[I]) != null && M[k] && (C = W(C, o[I][k]));
    const T = z1(r, b);
    return W(C, T);
  }
  function i(g) {
    const b = F1(g.config), C = q1(g.variantKeys, Object.keys(o));
    return B0({
      base: W(a, b.base),
      variants: Object.fromEntries(
        C.map((T) => [T, W(o[T], b.variants[T])])
      ),
      defaultVariants: C1(e, b.defaultVariants),
...
function z1(t, a) {
  let o = {};
  return t.forEach((e) => {
    Object.entries(e).every(([s, n]) => s === "css" ? !0 : (Array.isArray(n) ? n : [n]).some((h) => a[s] === h)) && (o = W(o, e.css));
  }), o;
}
function K2(t, a, o, e) {
...
const q = (t, a, o) => {
  ...
  return {
    recipeFn: (s, n = !0) => {
      const h = x0({
        ...
        utility: {
          toHash: (p, x) => x(p.join(":")),
          transform: (p, x) => (K2(t, o, s, p), x === "__ignore__" ? { className: t } : (x = S1(x), { className: `${t}--${p}_${x}` }))
        }
      }), w = e(s);
      if (n) {
        const p = z1(o, w);
    ...
    getVariantProps: e,
    __getCompoundVariantCss__: (s) => z1(o, e(s))
  };
}, z = (t, a) => {
  if (t && !a) return t;
  if (!t && a) return a;
  const o = (...s) => _(t(...s), a(...s)), e = q1(t.variantKeys, a.variantKeys), r = e.reduce((s, n) => (s[n] = q1(t.variantMap[n], a.variantMap[n]), s), {});
...
}), e1 = /* @__PURE__ */ q("box", {}, []), C0 = {}, N1 = Object.keys(C0), X2 = /* @__PURE__ */ Object.assign(y(e1.recipeFn), {
  __recipe__: !0,
  __name__: "box",
...
}), r1 = /* @__PURE__ */ q("breadcrumbs", {}, []), H0 = {}, D1 = Object.keys(H0), Y2 = /* @__PURE__ */ Object.assign(y(r1.recipeFn), {
  __recipe__: !0,
...
}, K1 = Object.keys(L0), G2 = /* @__PURE__ */ Object.assign(y(s1.recipeFn), {
  __recipe__: !0,
  __name__: "button",
...
}), l1 = /* @__PURE__ */ q("checkbox-input", {}, []), T0 = {}, X1 = Object.keys(T0), U2 = /* @__PURE__ */ Object.assign(y(l1.recipeFn), {
  __recipe__: !0,
...
}), i1 = /* @__PURE__ */ q("code", {}, []), A0 = {}, Y1 = Object.keys(A0), Z2 = /* @__PURE__ */ Object.assign(y(i1.recipeFn), {
  __recipe__: !0,
  __name__: "code",
...
}, U1 = Object.keys(O0), a6 = /* @__PURE__ */ Object.assign(y(m1.recipeFn), {
  __recipe__: !0,
  __name__: "iconButton",
...
}, Z1 = Object.keys(R0), o6 = /* @__PURE__ */ Object.assign(y(h1.recipeFn), {
  __recipe__: !0,
  __name__: "label",
...
}), w1 = /* @__PURE__ */ q("pre", {}, []), F0 = {}, t0 = Object.keys(F0), r6 = /* @__PURE__ */ Object.assign(y(w1.recipeFn), {
  __recipe__: !0,
  __name__: "pre",
...
}), v1 = /* @__PURE__ */ q("radio-input", {}, []), W0 = {}, a0 = Object.keys(W0), s6 = /* @__PURE__ */ Object.assign(y(v1.recipeFn), {
  __recipe__: !0,
  __name__: "radioInput",
...
}, r0 = Object.keys(K0), i6 = /* @__PURE__ */ Object.assign(y(u1.recipeFn), {
  __recipe__: !0,
  __name__: "text",
...
}, s0 = Object.keys(Q0), d6 = /* @__PURE__ */ Object.assign(y(y1.recipeFn), {
  __recipe__: !0,
  __name__: "textarea",
  __getCompoundVariantCss__: y1.__getCompoundVariantCss__,
  raw: (t) => t,
  variantKeys: s0,
  variantMap: Q0,
  merge(t) {
  ...
  getVariantProps: y1.getVariantProps
}), x1 = /* @__PURE__ */ q("textinput", {
  size: "medium"
}, []), X0 = {
  size: [
    "medium",
...
}, n0 = Object.keys(X0), c6 = /* @__PURE__ */ Object.assign(y(x1.recipeFn), {
  __recipe__: !0,
  __name__: "textinput",
  __getCompoundVariantCss__: x1.__getCompoundVariantCss__,
  raw: (t) => t,
  variantKeys: n0,
  variantMap: X0,
  merge(t) {
  ...
  getVariantProps: x1.getVariantProps
}), f1 = /* @__PURE__ */ q("toggle-input", {}, []), Y0 = {}, l0 = Object.keys(Y0), m6 = /* @__PURE__ */ Object.assign(y(f1.recipeFn), {
  __recipe__: !0,
  __name__: "toggleInput",
  __getCompoundVariantCss__: f1.__getCompoundVariantCss__,
  raw: (t) => t,
  variantKeys: l0,
  variantMap: Y0,
  merge(t) {
  ...
  getVariantProps: f1.getVariantProps
}), G0 = {}, h6 = [], p6 = [
  [
    "container",
    "checkbox__container"
...
], w6 = /* @__PURE__ */ p6.map(([t, a]) => [t, q(a, G0, $(h6, t))]), v6 = y((t = {}) => Object.fromEntries(w6.map(([a, o]) => [a, o.recipeFn(t)]))), i0 = [], g6 = (t) => ({ ...G0, ...j(t) }), b6 = /* @__PURE__ */ Object.assign(v6, {
  __recipe__: !1,
  __name__: "checkbox",
  raw: (t) => t,
  classNameMap: {},
...
], x6 = /* @__PURE__ */ y6.map(([t, a]) => [t, q(a, $0, $(u6, t))]), f6 = y((t = {}) => Object.fromEntries(x6.map(([a, o]) => [a, o.recipeFn(t)]))), d0 = [], _6 = (t) => ({ ...$0, ...j(t) }), q6 = /* @__PURE__ */ Object.assign(f6, {
  __recipe__: !1,
  __name__: "radio",
  raw: (t) => t,
  classNameMap: {},
...
], V6 = /* @__PURE__ */ z6.map(([t, a]) => [t, q(a, U0, $(k6, t))]), M6 = y((t = {}) => Object.fromEntries(V6.map(([a, o]) => [a, o.recipeFn(t)]))), c0 = [
  "position",
  "caret"
], B6 = (t) => ({ ...U0, ...j(t) }), S6 = /* @__PURE__ */ Object.assign(M6, {
  __recipe__: !1,
  __name__: "tooltip",
  raw: (t) => t,
  classNameMap: {},
...
], L6 = /* @__PURE__ */ H6.map(([t, a]) => [t, q(a, Z0, $(C6, t))]), P6 = y((t = {}) => Object.fromEntries(L6.map(([a, o]) => [a, o.recipeFn(t)]))), m0 = [
  "iconPlacement",
  "multiSelectType"
], T6 = (t) => ({ ...Z0, ...j(t) }), A6 = /* @__PURE__ */ Object.assign(P6, {
  __recipe__: !1,
  __name__: "menu",
  raw: (t) => t,
  classNameMap: {},
...
], O6 = /* @__PURE__ */ E6.map(([t, a]) => [t, q(a, J0, $(I6, t))]), R6 = y((t = {}) => Object.fromEntries(O6.map(([a, o]) => [a, o.recipeFn(t)]))), h0 = [], j6 = (t) => ({ ...J0, ...j(t) }), F6 = /* @__PURE__ */ Object.assign(R6, {
  __recipe__: !1,
  __name__: "toggle",
  raw: (t) => t,
  classNameMap: {},
...
}, U6 = (t) => typeof t == "string" ? t : (t == null ? void 0 : t.displayName) || (t == null ? void 0 : t.name) || "Component";
function _1(t, a = {}, o = {}) {
  const e = a.__cva__ || a.__recipe__ ? a : B0(a), r = o.shouldForwardProp || Y6, s = (g) => {
    var b;
    return (b = o.forwardProps) != null && b.includes(g) ? !0 : r(g, e.variantKeys);
  }, n = Object.assign(
    o.dataAttr && a.__name__ ? { "data-recipe": a.__name__ } : {},
    o.defaultProps
  ), i = $6(t.__cva__, e), h = G6(t, s), w = t.__base__ || t, p = /* @__PURE__ */ B1(function(b, C) {
    const { as: T = w, unstyled: M, children: I, ...k } = b, E = I1(() => Object.assign({}, n, k), [k]), [R, N, D, d, f] = I1(() => u(E, k1.keys, h, i.variantKeys, T1), [E]);
    function c() {
      var X;
      const { css: B, ...L } = d, K = (X = i.__getCompoundVariantCss__) == null ? void 0 : X.call(i, D);
      return _(i(D, !1), O(K, L, B), E.className);
    }
    function H() {
      const { css: B, ...L } = d, K = i.raw(D);
      return _(O(K, L, B), E.className);
    }
    const m = () => {
      if (M) {
        const { css: B, ...L } = d;
  ...
  return p.displayName = `styled.${x}`, p.__cva__ = i, p.__base__ = w, p.__shouldForwardProps__ = s, p;
}
function Z6() {
  ...
  return new Proxy(_1, {
    ...
    get(a, o) {
      return t.has(o) || t.set(o, _1(o)), t.get(o);
    }
  });
}
const a2 = /* @__PURE__ */ Z6(), p0 = {
  transform(t) {
    const { size: a, ...o } = t;
    return {
      width: a,
...
const w0 = {
  ...
  const a = P1(w0, t);
  return w0.transform(a, L1);
}, t5 = /* @__PURE__ */ B1(function(a, o) {
  const [e, r] = u(a, ["justify", "gap"]), s = J6(e), n = { ref: o, ...s, ...r };
  return a1(a2.div, n);
}), v0 = {
  transform(t, { map: a, isCssUnit: o }) {
    const { columnGap: e, rowGap: r, gap: s, columns: n, minChildWidth: i, ...h } = t, w = (p) => o(p) ? p : `token(sizes.${p}, ${p})`;
    return {
      display: "grid",
      gridTemplateColumns: n != null ? a(n, (p) => `repeat(${p}, minmax(0, 1fr))`) : i != null ? a(i, (p) => `repeat(auto-fit, minmax(${w(p)}, 1fr))`) : void 0,
      gap: s,
      columnGap: e,
      rowGap: r,
      ...h
  ...
  const a = P1(v0, t);
  return v0.transform(a, L1);
}, o5 = /* @__PURE__ */ B1(function(a, o) {
  const [e, r] = u(a, ["gap", "columnGap", "rowGap", "columns", "minChildWidth"]), s = a5(e), n = { ref: o, ...s, ...r };
  return a1(a2.div, n);
}), S = (t) => {
  const [a, o] = t2(t), { css: e, ...r } = a, s = O(e, r), n = o.className || "", i = _(n, s), { className: h, ...w } = o;
  return [i, w];
}, v = ({ as: t = "div", ...a }) => {
  const [o, e] = S(a), r = _(X2({}), o);
  return a1(t, {
    className: r,
    ...e
  });
  ...
  loading: t,
  children: a
}) => /* @__PURE__ */ V(b0, { children: [
  /* @__PURE__ */ l(t5, { gap: "2", opacity: t ? 0 : 1, children: a }),
  t && /* @__PURE__ */ l(
    o5,
    {
      position: "absolute",
    ...
    return (
      ...
      /* @__PURE__ */ l(
        v,
        {
          ...
          disabled: w,
          "aria-disabled": w,
          className: _(G2({ variant: t, size: a }), e),
          type: p === "button" ? "button" : void 0,
          ...i,
          children: /* @__PURE__ */ l(b0, { children: /* @__PURE__ */ l(r2, { loading: !!s, children: r }) })
        }
      )
    );
  }
  ...
  ({ variant: t, size: a, className: o, children: e, ...r }, s) => (
    ...
    /* @__PURE__ */ l(
      v,
      {
        as: "span",
        ref: s,
        className: _(Q2({ variant: t, size: a }), o),
        ...r,
        children: e
      }
    )
...
const P = ({
  ...
  const [r, s] = t2(e), { css: n, ...i } = r, h = O(n, i);
  return Y(() => {
    s5();
  }, []), /* @__PURE__ */ l(
    v,
    {
      ...
      className: _(e2({ size: a, fill: o }), h),
      ...s,
      children: /* @__PURE__ */ l("use", { xlinkHref: `#${t}` })
    }
  );
}, b5 = {
  ...
  ({
    ...
    const p = s || n, x = o ? "a" : "button", b = r ?? (i ? /* @__PURE__ */ l(P, { name: i, size: a === "small" ? "22" : "24" }) : null);
    return (
      // @ts-ignore
      /* @__PURE__ */ l(
        v,
        {
          ...
          disabled: p,
          "aria-disabled": p,
          className: _(a6({ variant: t, size: a }), e),
          type: x === "button" ? "button" : void 0,
          ...h,
          children: /* @__PURE__ */ l(r2, { loading: !!s, children: b })
        }
      )
    );
  }
  ...
  return /* @__PURE__ */ l(
    v,
    {
      ...
      lang: t,
      ...r,
      children: /* @__PURE__ */ l(A, { children: a })
    }
  );
}, y5 = ({
  children: t,
  ...
  const [e, r] = S(o);
  return /* @__PURE__ */ l(v, { as: "pre", className: _(r6({}), e), ...r, children: /* @__PURE__ */ l(n5, { lang: a, slot: "react", bg: "transparent", ...r, children: t }) });
}, x5 = ({
  level: t = "h2",
  children: a,
  ...o
  ...
  return /* @__PURE__ */ V(
    v,
    {
      ...
      children: [
        e,
        a && /* @__PURE__ */ l(P, { name: "arrow-square-out", size: "20" })
      ]
    }
  );
}, l5 = ({
  ...
  return /* @__PURE__ */ l(
    ...
    {
      as: "div",
      className: _(J2({ direction: t, weight: a }), e),
      ...r
    }
  );
}, Q = ({
  ...
  const { container: n, input: i, indicator: h } = b6({});
  return /* @__PURE__ */ V(
    Q,
    {
      className: n,
      color: a ? "red.50" : { base: "gray.90", _dark: "gray.0" },
      children: [
        /* @__PURE__ */ l(
          v,
          {
        ...
        /* @__PURE__ */ l(P, { className: h, name: "checkbox" }),
        /* @__PURE__ */ l(P, { className: h, name: "checkbox-checked" }),
        /* @__PURE__ */ l(P, { className: h, name: "checkbox-indeterminate" }),
        /* @__PURE__ */ l(P, { className: h, name: "checkbox-focus" })
      ]
    }
  );
}, i5 = ({ id: t, name: a, error: o, ...e }) => {
  const { container: r, input: s, indicator: n } = q6({});
  return /* @__PURE__ */ V(Q, { className: r, htmlFor: t, children: [
    /* @__PURE__ */ l(
      v,
      {
        as: "input",
    ...
    /* @__PURE__ */ l(P, { className: n, name: "radio" }),
    /* @__PURE__ */ l(P, { className: n, name: "radio-checked" }),
    /* @__PURE__ */ l(P, { className: n, name: "radio-focus" })
  ] });
}, f5 = ({
  size: t,
  error: a,
  ...
  return /* @__PURE__ */ l(
    v,
    {
      ...
      "aria-describedby": s,
      ...a && { "data-error": !0 },
      className: _(c6({ size: t, autoSize: o }), i),
      ...h
    }
  );
}, d5 = ({
...
const _5 = ({
  ...
  const { container: n, input: i, indicator: h, background: w } = F6({});
  return /* @__PURE__ */ V(
    Q,
    {
      className: n,
      ...
      children: [
        ...
        /* @__PURE__ */ l(v, { as: "span", className: w, name: "toggle-bg" }),
        /* @__PURE__ */ l(P, { name: "circle", className: h }),
        /* @__PURE__ */ l(
          P,
          {
            name: "circle-check",
  ...
  return /* @__PURE__ */ V(
    Q,
    {
      ...
      children: [
        ...
        e && /* @__PURE__ */ l(v, { as: "div", children: e })
      ]
    }
  );
}, z5 = ({
      ...
      children: [
        /* @__PURE__ */ l(
          n2,
          {
            id: t,
            name: a,
            labelledby: t ? `${t}-description` : void 0,
            ...e && { "data-error": !0 },
            ...r && { "data-indeterminate": !0 },
            ...s
          }
        ),
        o && /* @__PURE__ */ l(A, { as: "span", id: `${t}-description`, children: o })
      ]
    }
  );
}, V1 = "okshaun-theme-preference";
function c5() {
  const t = localStorage.getItem(V1);
  return t || (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light");
}
const i2 = d2(void 0);
function V5({ children: t }) {
  const [a, o] = G(() => c5()), e = (r) => {
    o(r), localStorage.setItem(V1, r);
  };
  return Y(() => {
    ...
    const r = window.matchMedia("(prefers-color-scheme: dark)"), s = (n) => {
      localStorage.getItem(V1) || o(n.matches ? "dark" : "light");
    };
    return r.addEventListener("change", s), () => r.removeEventListener("change", s);
  }, []), /* @__PURE__ */ l(i2.Provider, { value: { theme: a, setTheme: e }, children: t });
}
function m5() {
  const t = c2(i2);
  if (t === void 0)
...
const B5 = ({
  ...
  const [i, h] = G(s), { wrapper: w, tooltipContent: p } = S6({
    position: i,
    caret: a
  }), [x, g] = G(!1), b = E1(null), C = E1(null), T = typeof s == "string" ? s : "bottom", M = [
    "bottom",
    "bottom-start",
    "bottom-end",
    "left",
  ...
  const k = () => {
    ...
    if (!d || !f) return;
    const c = f.getBoundingClientRect(), H = I(T);
    for (const m of [T, ...H]) {
      const B = E(
        c,
        d.offsetWidth,
  ...
  return Y(() => {
  ...
  }, [t]), /* @__PURE__ */ V(v, { ...n, className: w, children: [
    /* @__PURE__ */ l(
      v,
      {
        ref: C,
    ...
    x && /* @__PURE__ */ V(v, { className: p, ref: b, children: [
      e && /* @__PURE__ */ l(
        A,
        {
          as: "p",
  ...
  const [o, e] = S(a);
  return /* @__PURE__ */ l(A, { as: "ul", className: _(Y2({}), o), ...e, children: t == null ? void 0 : t.map((r, s) => /* @__PURE__ */ V(A, { as: "li", children: [
    r.href ? /* @__PURE__ */ l(s2, { family: "mono", size: "14", href: r.href, children: r.label }) : /* @__PURE__ */ l(A, { weight: "bold", family: "mono", size: "14", children: r.label }),
    s < (t == null ? void 0 : t.length) - 1 && /* @__PURE__ */ l(A, { as: "span", family: "mono", size: "14", children: "/" })
  ] }, r.id)) });
}, C5 = ({
  variant: t,
  hue: a,
  ...
  return /* @__PURE__ */ V(
    ...
    {
      as: "span",
      className: _(l6({ variant: t, hue: a, iconPosition: o, hasIcon: !!r }), n),
      ...i,
      children: [
        r && /* @__PURE__ */ l(P, { name: r, width: 20, height: 20 }),
        e
      ]
    }
  );
  ...
  const {
    ...
    o === "single-select" ? M.includes(c) ? (I([]), r == null || r(null)) : (I([c]), r == null || r(c)) : (I(
      ...
      v,
      {
        ...
        children: (f = R == null ? void 0 : R.menu) == null ? void 0 : f.map((c) => {
          ...
          return /* @__PURE__ */ V(v, { children: [
            c.title && /* @__PURE__ */ l(v, { className: i, children: /* @__PURE__ */ l(A, { textStyle: "body-xs", children: c == null ? void 0 : c.title }) }),
            /* @__PURE__ */ l(v, { children: (H = c == null ? void 0 : c.items) == null ? void 0 : H.map((m) => {
              var A1;
              const B = !!((A1 = m.children) != null && A1.length), L = M.includes(m.id), K = !!(m != null && m.disabled), X = () => {
                K || (m != null && m.children ? D(m.children, m.label) : N(m.id));
              };
              return /* @__PURE__ */ V(
                v,
                {
                  ...
                  onClick: X,
                  onKeyDown: (U) => {
                    (U.key === " " || U.key === "Spacebar" || U.key === "Enter") && (U.preventDefault(), X());
                  },
                  role: "button",
                  "aria-pressed": L,
                  children: [
                    (a || (m == null ? void 0 : m.iconName)) && /* @__PURE__ */ l(
                      v,
                      {
                        className: T,
                        color: { base: "gray.90", _dark: "gray.0" },
                        children: (m == null ? void 0 : m.iconName) && /* @__PURE__ */ l(P, { name: `${m == null ? void 0 : m.iconName}` })
                      }
                    ),
                    ...
                    o === "multi-select" && e === "toggle" && !(c != null && c.link) && /* @__PURE__ */ l(
                      l2,
                      {
                        name: "menu-toggle",
                        checked: L,
                    ...
                    !(c != null && c.link) && /* @__PURE__ */ V(v, { children: [
                      ...
                      (m == null ? void 0 : m.description) && /* @__PURE__ */ l(A, { textStyle: "body-xs", className: p, children: m == null ? void 0 : m.description })
                    ] }),
                    (c == null ? void 0 : c.link) && /* @__PURE__ */ V(
                      s2,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          /* @__PURE__ */ l(P, { name: "arrow-square-out" })
                        ]
                      }
                    ),
                    B && /* @__PURE__ */ l(
                      v,
                      {
                        className: g,
                        color: { base: "gray.90", _dark: "gray.0" },
                        children: /* @__PURE__ */ l(P, { name: "caret-right" })
                      }
                    )
                  ]
                },
            ...
            (c == null ? void 0 : c.divider) && /* @__PURE__ */ l(v, { className: b, children: /* @__PURE__ */ l(l5, { color: { base: "gray.10", _dark: "gray.60" } }) }),
            (c == null ? void 0 : c.spacer) && /* @__PURE__ */ l(v, { className: C })
          ] }, c.id);
        })
      }
    )
